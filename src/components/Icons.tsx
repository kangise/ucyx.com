export const Icons = {
  ...
  // New icons needed for AboutPage
  ...
  Email: () => (
    <div className="w-5 h-5 bg-green-50 border border-green-100 rounded-md flex items-center justify-center">
  ...
  StatusIndicator: ({ color = "green" }: { color?: string }) => (
    <div className="w-3 h-3 bg-green-50 border border-green-100 rounded-full flex items-center justify-center">
